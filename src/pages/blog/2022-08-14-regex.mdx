...
date: 2022-08-14
draft: false
featuredImage: '/images/blog/book-face-640.jpg'
featuredImageAlt: 'A woman with a book literally on her face'
---

import { readableDate } from '../../js/utilities'

<p class='section__title'>{readableDate(frontmatter.date)}</p>
